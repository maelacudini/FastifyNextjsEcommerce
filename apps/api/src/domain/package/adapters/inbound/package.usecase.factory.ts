import { FindAllPackagesUseCase } from "@/domain/package/application/find-all-packages.usecase.js"
import { PostgresPackageRepository } from "../outbound/package.repository.postgres.js"
import { FindAllActivePackagesUseCase } from "@/domain/package/application/find-all-active-packages.usecase.js"
import { FindPackageByIdUseCase } from "@/domain/package/application/find-package-by-id.usecase copy.js"
import { CreatePackageUseCase } from "@/domain/package/application/create-package.usecase.js"
import { UpdatePackageUseCase } from "@/domain/package/application/update-package.usecase.js"
import { DeletePackageUseCase } from "@/domain/package/application/delete-package.usecase.js"
import { SetIsPackageDisabledUseCase } from "@/domain/package/application/set-is-package-disabled.usecase.js"
